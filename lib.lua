...
function Luxt.CreateWindow(libName, logoId)
    ...
    function TabHandling:LuxtTab(tabText, tabId)
        ...
        function sectionHandling:LuxtSection(sectionText)
            ...
            function ItemHandling:LuxtButton(btnText, callback)
                ...
                function ItemHandling:LuxtToggle(toggInfo, callback)
                    ...
                    function ItemHandling:LuxtKeyBind(keyInfo, first, callback)
                        --
                        ...
                        function ItemHandling:LuxtTextBox(infbix, textPlace, callback)
                            --
                            ...
                            function ItemHandling:LuxtSlider(slidInfo, minvalue, maxvalue, callback)
                            ...
                            function ItemHandling:LuxtLabel(labelInfo)
                            ...
                            function ItemHandling:LuxtCredit(creditWho)
                                local TextLabelFrame = Instance.new("Frame")
                                local UIListLayout = Instance.new("UIListLayout")
                                local TextLabel = Instance.new("TextLabel")
                                local UICorner = Instance.new("UICorner")
                                ...
                                function ItemHandling:LuxtDropDown(dropInfo, list, callback)
                                    callback = callback or function() end
                                    list = list or {}
